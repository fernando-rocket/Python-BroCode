...
app = Tk()
app.title("Calculator program")
app.geometry("500x600")

equation_text = ""
equation_label = StringVar()

label = Label(app, textvariable=equation_label, font=("consolas", 20), bg="white", width=24, height=2)
label.pack()
...
clear = Button(app, text="clear", height=4, width=12, font=35, command=clear)
